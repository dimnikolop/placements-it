            ...
            <form id="studentQuestionnaireForm" action="{{ route('questionnaires.student.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio1_4" name="answer4" value="Προσωπικές γνωριμίες" @if (old('answer4') == 'Προσωπικές γνωριμίες') checked @endif>
                        <label class="custom-control-label" for="radio1_4">Προσωπικές γνωριμίες</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio2_4" name="answer4" value="Συνέντευξη" @if (old('answer4') == 'Συνέντευξη') checked @endif>
                        <label class="custom-control-label" for="radio2_4">Συνέντευξη</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio3_4" name="answer4" value="Ιστοσελίδα Τμήματος" @if (old('answer4') == 'Ιστοσελίδα Τμήματος') checked @endif>
                        <label class="custom-control-label" for="radio3_4">Ιστοσελίδα Τμήματος</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio4_4" name="answer4" value="Συστάσεις από καθηγητές" @if (old('answer4') == 'Συστάσεις από καθηγητές') checked @endif>
                        <label class="custom-control-label" for="radio4_4">Συστάσεις από καθηγητές</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio5_4" name="answer4" value="Συστάσεις από τρίτους" @if (old('answer4') == 'Συστάσεις από τρίτους') checked @endif>
                        <label class="custom-control-label" for="radio5_4">Συστάσεις από τρίτους</label>
                    </div>
                    <div class="row">
                        <div class="col-auto">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="radio6_4" name="answer4" value="Άλλο" @if (old('answer4') == 'Άλλο') checked @endif>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio1_14" name="answer14" value="0 ώρες" @if (old('answer14') == '0 ώρες') checked @endif>
                        <label class="custom-control-label" for="radio1_14">0 ώρες</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio2_14" name="answer14" value="1-2 ώρες" @if (old('answer14') == '1-2 ώρες') checked @endif>
                        <label class="custom-control-label" for="radio2_14">1-2 ώρες</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio3_14" name="answer14" value="3-6 ώρες" @if (old('answer14') == '3-6 ώρες') checked @endif>
                        <label class="custom-control-label" for="radio3_14">3-6 ώρες</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio4_14" name="answer14" value="7-10 ώρες" @if (old('answer14') == '7-10 ώρες') checked @endif>
                        <label class="custom-control-label" for="radio4_14">7-10 ώρες</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio5_14" name="answer14" value="πάνω από 10 ώρες" @if (old('answer14') == 'πάνω από 10 ώρες') checked @endif>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio1_15" name="answer15" value="Αναλυτής Εφαρμογών" @if (old('answer15') == 'Αναλυτής Εφαρμογών') checked @endif>
                        <label class="custom-control-label" for="radio1_15">Αναλυτής Εφαρμογών</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio2_15" name="answer15" value="Αναλυτής Συστημάτων" @if (old('answer15') == 'Αναλυτής Συστημάτων') checked @endif>
                        <label class="custom-control-label" for="radio2_15">Αναλυτής Συστημάτων</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio3_15" name="answer15" value="Προγραμματιστής Εφαρμογών" @if (old('answer15') == 'Προγραμματιστής Εφαρμογών') checked @endif>
                        <label class="custom-control-label" for="radio3_15">Προγραμματιστής Εφαρμογών</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio4_15" name="answer15" value="Διαχειριστής Δικτύου" @if (old('answer15') == 'Διαχειριστής Δικτύου') checked @endif>
                        <label class="custom-control-label" for="radio4_15">Διαχειριστής Δικτύου</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio5_15" name="answer15" value="Διαχειριστής Βάσεων Δεδομένων" @if (old('answer15') == 'Διαχειριστής Βάσεων Δεδομένων') checked @endif>
                        <label class="custom-control-label" for="radio5_15">Διαχειριστής Βάσεων Δεδομένων</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio6_15" name="answer15" value="Προγραμματιστής Συστημάτων" @if (old('answer15') == 'Προγραμματιστής Συστημάτων') checked @endif>
                        <label class="custom-control-label" for="radio6_15">Προγραμματιστής Συστημάτων</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio7_15" name="answer15" value="Web developer" @if (old('answer15') == 'Web developer') checked @endif>
                        <label class="custom-control-label" for="radio7_15">Web developer</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input class="custom-control-input" type="radio" id="radio8_15" name="answer15" value="Service Η/Υ" @if (old('answer15') == 'Service Η/Υ') checked @endif>
                        <label class="custom-control-label" for="radio8_15">Service Η/Υ</label>
                    </div>
                    <div class="row">
                        <div class="col-auto">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="radio9_15" name="answer15" value="Άλλο" @if (old('answer15') == 'Άλλο') checked @endif>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check1_21" name="answer21[]" value="Γλώσσες/Μεθοδολογίες Προγραμματισμού" @if (old('answer21') && in_array('Γλώσσες/Μεθοδολογίες Προγραμματισμού', old('answer21'))) checked @endif>
                                <label class="custom-control-label" for="check1_21">Γλώσσες/Μεθοδολογίες Προγραμματισμού</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check2_21" name="answer21[]" value="Λειτουργικά Συστήματα" @if (old('answer21') && in_array('Λειτουργικά Συστήματα', old('answer21'))) checked @endif>
                                <label class="custom-control-label" for="check2_21">Λειτουργικά Συστήματα</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check3_21" name="answer21[]" value="Αρχιτεκτονική Η/Υ" @if (old('answer21') && in_array('Αρχιτεκτονική Η/Υ', old('answer21'))) checked @endif>
                                <label class="custom-control-label" for="check3_21">Αρχιτεκτονική Η/Υ</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check4_21" name="answer21[]" value="Δίκτυα" @if (old('answer21') && in_array('Δίκτυα', old('answer21'))) checked @endif>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check5_21" name="answer21[]" value="Οργάνωση Διοίκηση Επιχειρήσεων" @if (old('answer21') && in_array('Οργάνωση Διοίκηση Επιχειρήσεων', old('answer21'))) checked @endif>
                                <label class="custom-control-label" for="check5_21">Οργάνωση Διοίκηση Επιχειρήσεων</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check6_21" name="answer21[]" value="Βάσεις Δεδομένων" @if (old('answer21') && in_array('Βάσεις Δεδομένων', old('answer21'))) checked @endif>
                                <label class="custom-control-label" for="check6_21">Βάσεις Δεδομένων</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check7_21" name="answer21[]" value="Πολυμέσα" @if (old('answer21') && in_array('Πολυμέσα', old('answer21'))) checked @endif>
                                <label class="custom-control-label" for="check7_21">Πολυμέσα</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check8_21" name="answer21[]" value="Διαδίκτυο" @if (old('answer21') && in_array('Διαδίκτυο', old('answer21'))) checked @endif>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check9_21" name="answer21[]" value="Τεχνητή Νοημοσύνη/Ευφυή Συστήματα" @if (old('answer21') && in_array('Τεχνητή Νοημοσύνη/Ευφυή Συστήματα', old('answer21'))) checked @endif>
                                <label class="custom-control-label" for="check9_21">Τεχνητή Νοημοσύνη/Ευφυή Συστήματα</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check10_21" name="answer21[]" value="Πληροφοριακά Συστήματα" @if (old('answer21') && in_array('Πληροφοριακά Συστήματα', old('answer21'))) checked @endif>
                                <label class="custom-control-label" for="check10_21">Πληροφοριακά Συστήματα</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check11_21" name="answer21[]" value="Γραφικά" @if (old('answer21') && in_array('Γραφικά', old('answer21'))) checked @endif>
                                <label class="custom-control-label" for="check11_21">Γραφικά</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="check12_21" name="answer21[]" value="Άλλο" @if (old('answer21') && in_array('Άλλο', old('answer21'))) checked @endif>
                ...
                <div class="form-group">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-xl-8">
                            <input class="form-control form-control-sm" type="text" id="subject1" name="answer22[]" value="{{ old('answer22.0') }}">
                        </div>
                    </div>
                    <div class="row align-items-center">
                        <label class="col-form-label col-auto">2.</label>
                        <div class="col col-xl-8">
                            <input class="form-control form-control-sm" type="text" id="subject2" name="answer22[]" value="{{ old('answer22.1') }}">
                        </div>
                    </div>
                    <div class="row align-items-center">
                        <label class="col-form-label col-auto">3.</label>
                        <div class="col col-xl-8">
                            <input class="form-control form-control-sm" type="text" id="subject3" name="answer22[]" value="{{ old('answer22.2') }}">
                        </div>
                    </div>
                    @error('answer22')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio24None" name="answer24" value="Καθόλου" @if (old('answer24') == 'Καθόλου') checked @endif>
                        <label class="custom-control-label" for="radio24None">Καθόλου</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio24Little" name="answer24" value="Λίγο"  @if (old('answer24') == 'Λίγο') checked @endif>
                        <label class="custom-control-label" for="radio24Little">Λίγο</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio24Enough" name="answer24" value="Αρκετά" @if (old('answer24') == 'Αρκετά') checked @endif>
                        <label class="custom-control-label" for="radio24Enough">Αρκετά</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio24Very" name="answer24" value="Πολύ" @if (old('answer24') == 'Πολύ') checked @endif>
                        <label class="custom-control-label" for="radio24Very">Πολύ</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio24VeryMuch" name="answer24" value="Πάρα πολύ" @if (old('answer24') == 'Πάρα πολύ') checked @endif>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio25Yes" name="answer25" value="Ναι" @if (old('answer25') == 'Ναι') checked @endif>
                        <label class="custom-control-label" for="radio25Yes">Ναι</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio25No" name="answer25" value="Όχι" @if (old('answer25') == 'Όχι') checked @endif>
                ...
                <div class="form-group mb-5">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio26None" name="answer26" value="Καθόλου" @if (old('answer26') == 'Καθόλου') checked @endif>
                        <label class="custom-control-label" for="radio26None">Καθόλου</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio26Little" name="answer26" value="Λίγο"  @if (old('answer26') == 'Λίγο') checked @endif>
                        <label class="custom-control-label" for="radio26Little">Λίγο</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio26Enough" name="answer26" value="Αρκετά" @if (old('answer26') == 'Αρκετά') checked @endif>
                        <label class="custom-control-label" for="radio26Enough">Αρκετά</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio26Very" name="answer26" value="Πολύ" @if (old('answer26') == 'Πολύ') checked @endif>
                        <label class="custom-control-label" for="radio26Very">Πολύ</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input class="custom-control-input" type="radio" id="radio26VeryMuch" name="answer26" value="Πάρα πολύ" @if (old('answer26') == 'Πάρα πολύ') checked @endif>
